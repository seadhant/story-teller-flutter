...
List<Story> _storyData = [
  Story(
      'NABINA ra priya MOTA kiye ??',
       'BIBEK',
       'ADITYA'),
  Story(
       'ADITYA thu besi alasua kie ??',
       'BIBEK',
        'ABHUDIN'),
  Story(
  ...
  Story(
      ...
      'PURA PURI THIK, they have a history',
       'Restart',
      '')
];
    ...
    String getStory(){
      return _storyData[_stno].storyTitle;
    }

    String getChoice1(){
      return _storyData[_stno].choice1;
    }

    String getChoice2(){
      return _storyData[_stno].choice2;
    }
    ...
    void nextStory(cno){
      ...
      if (cno == 1 && _stno == 0) {
        _stno = 2;
      } else if (cno == 2 && _stno == 0) {
        _stno = 1;
      } else if (cno == 1 && _stno == 1) {
        _stno = 2;
      } else if (cno == 2 && _stno == 1) {
        _stno = 3;
      } else if (cno == 1 && _stno == 2) {
        _stno = 5;
      } else if (cno == 2 && _stno == 2) {
        _stno = 4;
      }
      //TODO: Step 22 - In nextStory() if the storyNumber is equal to 3 or 4 or 5, that means it's the end of the game and it should call a method called restart() that resets the storyNumber to 0.
      else if (_stno == 3 || _stno == 4 || _stno == 5) {
        restart();
    }
